...
\newrefformat{fig}{{\color{CarminePink}图\ref{#1}}}
\newrefformat{tab}{{\color{CarminePink}表\ref{#1}}}
\newrefformat{cha}{{\color{CarminePink}第\ref{#1}章\nameref{#1}}}
\newrefformat{app}{{\color{CarminePink}附录\ref{#1}\nameref{#1}}}
\newrefformat{sec}{{\color{CarminePink}第\ref{#1}节\nameref{#1}}}
