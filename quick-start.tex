...
% 页面设置
\usepackage[papersize={13cm,18.4cm},top=1.8cm,bottom=2cm,left=2.1cm,right=1.8cm]{geometry}
...
\usepackage{fancyhdr}
\pagestyle{fancy}
\newcommand\myfoot{\zihao{5}\color{lightgray}\sffamily---~{\color{black}\thepage}~---}
...
\ctexset{
    ...
    chapter = {
        ...
        afterskip = 20pt,
        fixskip = true,
        format = \Huge\bfseries\setlength\parindent{0pt},
    ...
    section = {
        beforeskip = 10pt plus 6pt minus 4pt,
        afterskip = 4pt plus 6pt minus 4pt,
        numberformat = \color{CarminePink},
    },
    subsection = {
        beforeskip = 6pt plus 6pt minus 4pt,
        afterskip = 4pt plus 6pt minus 4pt,
        numberformat = \color{CarminePink},
    },
    subsubsection = {
...
\usepackage{titletoc}
\contentsmargin{2em}
\dottedcontents{chapter}[4em]{\sffamily}{4em}{1pc}
...
\newcommand{\innerinfo}[3]{\par\vspace{4pt}\noindent
...
\pagenumbering{roman}
{\linespread{1.6}\small\tableofcontents}
\newpage
