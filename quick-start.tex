...
\usepackage{fancyhdr}
\pagestyle{fancy}
\newcommand\myfoot{\zihao{3}\color{SmrtSunglo}\itshape--~\thepage~--}
...
\ctexset{
    ...
    chapter = {
        ...
        nameformat = {\color{gray!50!white}\rule{\linewidth}{1pt}}\par\chapternamebox,
        number = \arabic{chapter},
        numberformat = \color{CarminePink}\zihao{0}\itshape,
        % aftername = \par\medskip,
        aftertitle = \par\bigskip\nointerlineskip{\color{LightRose}\rule{\linewidth}{2pt}}\par
    },
    section = {
