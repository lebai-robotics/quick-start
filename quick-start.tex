...
% 颜色
\usepackage[dvipsnames, cmyk, table]{xcolor} % cmyk
...
\ctexset{
    ...
    section = {
        ...
        numberformat = \color{CarminePink}\S,
    },
    subsection = {
...
\newcommand{\innerinfo}[3]{{\setlength{\parindent}{0pt}\par\vspace*{6pt}
