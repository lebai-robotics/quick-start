...
\definecolor{Success}{HTML}{03D37D}
...
\newcommand\tablenote[1]{\par\vspace*{1em}\par{\small{\sffamily \Note}#1}}
...
\newcommand\myleft{\zihao{7}\color{darkgray}\kaishu\leftmark}
\newcommand\myright{\zihao{7}\color{darkgray}\kaishu\rightmark}
\fancyhf{}
...
\ctexset{
    ...
    section = {
        beforeskip = 1em plus 0.6em minus 1em,
        afterskip = 0.4em plus 0.6em minus 0.4em,
        format = \Large\sffamily\bfseries\raggedright ,
        numberformat = \color{CarminePink},
    },
    subsection = {
        beforeskip = 0.3em plus 0.3em minus 0.3em,
        afterskip = 0.0em plus 0.3em minus 0.0em,
        format = \large\sffamily\bfseries\raggedright ,
        numberformat = \color{CarminePink},
    },
    subsubsection = {
        beforeskip = 0.0em plus 0.3em minus 0.0em,
        afterskip = 0.0em plus 0.3em minus 0.0em,
        format = \normalsize\sffamily\bfseries,
        numberformat = \color{CarminePink},
    },
    paragraph = {
        format = \normalsize\sffamily\bfseries\color{CarminePink},
        % aftertitle = \@@par,
    },
    subparagraph = {
...
% 目录
\contentsmargin{2em}
\dottedcontents{chapter}[6em]{\addvspace{6pt}\sffamily}{6em}{1mm}
\dottedcontents{section}[4em]{}{3em}{1mm}
\dottedcontents{subsection}[6em]{}{4em}{1mm}
\dottedcontents{subsubsection}[8em]{}{4em}{1mm}
...
\newcommand{\innerinfo}[3]{{\setlength{\parindent}{0pt}\par
    ...
    \vspace{0pt}
    {\bfseries #2}\par\kaishu #3
    \end{minipage}\medskip}
}
}
\newcommand{\info}[1]{\innerinfo{\includegraphics[width=1cm]{image/ic_w_info.pdf}}{\Info}{#1}}
\newcommand{\dange}[1]{\innerinfo{\includegraphics[width=1cm]{image/ic_w_flash.pdf}}{\Dange}{#1}}
\newcommand{\danger}[2][\Danger]{\innerinfo{\includegraphics[width=1cm]{image/ic_w_warning.pdf}}{#1}{#2}}
...
\newcommand{\btn}[2][Primary]{\tcbox[left=10pt,right=10pt,top=4pt,bottom=4pt,colframe=#1,colback=#1,colupper=white,arc=8pt]{\sffamily\uppercase{#2}}}
