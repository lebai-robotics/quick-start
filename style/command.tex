...
\newcommand{\info}[1]{\innerinfo{\includegraphics[width=1.5cm]{image/ic_w_info.pdf}}{\Info}{#1}}
\newcommand{\dange}[1]{\innerinfo{\includegraphics[width=1.5cm]{image/ic_w_flash.pdf}}{\Dange}{#1}}
\newcommand{\danger}[2][\Danger]{\innerinfo{\includegraphics[width=1.5cm]{image/ic_w_warning.pdf}}{#1}{#2}}
