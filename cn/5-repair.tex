...
维护维修工作务必严格遵守{\ThisBook}的所有安全指示。

维护、校准、维修工作必须根据最新的{\ThatBook}进行操作，{\ThatBook}可以在乐白官网 \url{https://i.lebai.ltd/d/s/} 上查看。
...
{\setlength{\parindent}{0pt} 操作机器人或控制箱时必须遵循以下安全程序和警告事项：}

\innerinfo{\includegraphics[width=1cm]{image/ic_w_flash.pdf}
\\\includegraphics[width=1cm]{image/ic_w_warning.pdf}
}{}{\begin{itemize}
\item 维修时需要采取必要的预防措施以避免其他人在维修期间重新接通系统电源。断电之后仍要重新检查系统，确保其确已断电。
\item 重新开启系统前请检查电源插头接地连接。
...
% \innerinfo{\includegraphics[width=1cm]{image/ic_w_warning.pdf}
% \\\includegraphics[width=1cm]{image/ic_w_flash.pdf}
% }{}{\begin{itemize}
